...
namespace ConexionDGII
{
    public class FacturacionElectronicaDGII
    {
        ...
        {
            return ObtenerSemilla(urlSemilla, passCert, jsonInvoice).GetAwaiter().GetResult();
        }

        public static async Task<string> ObtenerSemilla(string urlSemilla, string passCert, string jsonInvoice)
        {
        ...
        public static async Task<string> FirmarSemilla(string passCert, string jsonContentTable, string xmlContent)
        {
